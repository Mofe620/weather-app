...
export default function Weather({data}) {
  ...
  return (
    <div className='weather-card bg-fuchsia-50 border-t-4 border-b-4 border-l-2 border-r-2 border-sky-800 rounded-md m-8 shadow-2xl shadow-slate-400 p-4 cursor-pointer'>
